...
Global permutation importance, approximate interventional SHAP values, a local surrogate, partial dependence, and individual conditional-effect plots describe the fitted model. These methods show model associations and must not be interpreted as causal treatment effects.
