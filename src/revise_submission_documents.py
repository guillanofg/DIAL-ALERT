...
FUTURE = [
    ...
    ("Reproducibility status", "A new Python 3.12 environment was created on 18 September 2026. Source acquisition returned HTTP 403; end-to-end data-to-training reproduction therefore remains blocked. Included-model inference and application checks are recorded separately in docs/REPRODUCIBILITY_RECORD.md. Those checks do not verify the original training results."),
